...
matplot(x = result2[,1], y = result2[,-1], type = 'l', ylab = "Post Samp", xlab = "x", main = "alpha = 100", ylim = c(-10,10))
```
...
Something looks incorrect.. they should have similar variability
